...
源代码: [vllm-project/vllm](https://raw.githubusercontent.com/vllm-project/vllm/main/examples/offline_inference_vision_language.py)
...
def run_minicpmv(question):
    ...
    # 官方仓库尚未可用，因此我们现在需要使用一个 fork
    # 更多细节，请参见：https://github.com/vllm-project/vllm/pull/4087#issuecomment-2250397630 # noqa
    ...
    # 注意：不同版本的 MiniCPM-V 的 stop_token_ids 是不同的。
    # 2.0
